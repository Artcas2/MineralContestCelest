...
public class PlayerInteract implements Listener {
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (mineralcontest.isAMineralContestWorld(worldEvent)) {
            ...
            if (partie != null && !partie.isGameStarted() && (event.getAction().equals((Object)Action.LEFT_CLICK_BLOCK) || event.getAction().equals((Object)Action.RIGHT_CLICK_BLOCK)) && !Setup.premierLancement) {
                event.setCancelled(true);
                if (mineralcontest.enable_block_warning) {
                    event.getPlayer().sendMessage(mineralcontest.prefixPrive + Lang.cant_interact_block_pre_game.toString());
                }
            }
        }
    ...
    public void blockVillagerTrades(PlayerInteractAtEntityEvent entityEvent) {
        ...
        if (mineralcontest.isAMineralContestWorld(current_world)) {
            ...
            if (entityEvent.getRightClicked() instanceof Villager || entityEvent.getRightClicked() instanceof Witch || entityEvent.getRightClicked() instanceof TraderLlama || entityEvent.getRightClicked() instanceof WanderingTrader || entityEvent.getRightClicked() instanceof Golem || entityEvent.getRightClicked() instanceof IronGolem) {
