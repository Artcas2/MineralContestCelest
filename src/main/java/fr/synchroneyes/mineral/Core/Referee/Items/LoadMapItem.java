...
public class LoadMapItem extends RefereeItemTemplate {
    ...
    public void performClick(Player joueur) {
        ...
        if (groupe == null || !groupe.getEtatPartie().equals((Object)Etats.EN_ATTENTE)) {
        ...
        if (this.customName.length() > 1) {
            groupe.chargerMonde(this.customName);
        }
    }
    ...
    public String getDescriptionItem() {
        return Lang.referee_item_map_selector_description.toString() + this.customName;
    }
