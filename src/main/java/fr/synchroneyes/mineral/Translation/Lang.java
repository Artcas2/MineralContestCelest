...
public enum Lang {
    ...
    arena_spawnzone_not_added("arena_spawnzone_not_added", "La zone de spawn de l'arène n'est pas défini"),
    ...
    vote_winning_biome("vote_winning_biome", "Le biome sélectionné est %winningBiome%"),
    ...
    vote_started("vote_started", "Le vote a démarré ! Vous pouvez voter pour votre biome préféré avec la commande /vote <numéro du monde>"),
    ...
    hud_team_name_no_score("hud_team_name_no_score", "%teamColor% Équipe %teamName%"),
    hud_team_name_score("hud_team_name_score", "%teamColor% Équipe %teamName% : %teamScore% points"),
    ...
    admin_played_tried_to_login("admin_played_tried_to_login", "Le joueur %playerName% a tenté de se connecter alors que la partie est déjà en cours. Pour le laisser se connecter, faites pause puis attribuez lui une équipe avec la commande /switch <pseudo> <équipe>"),
    ...
    ready_tag("ready_tag", "[PRÊT]"),
    not_ready_tag("not_ready_tag", "[NON PRÊT]"),
    ...
    warn_player_you_dont_have_a_team("warn_player_you_dont_have_a_team", "Attention, vous n'êtes pas dans une équipe. Vous pouvez rejoindre une équipe avec la commande /join <nomÉquipe>"),
    ...
    cvar_friendly_fire_enabled("cvar_friendly_fire_enabled", "Les dégâts entre coéquipiers sont désormais actif"),
    cvar_friendly_fire_disabled("cvar_friendly_fire_disabled", "Les dégâts entre coéquipiers sont désormais désactivés"),
    ...
    error_group_is_not_locked("error_group_is_not_locked", "Le groupe n'est pas verrouillé"),
    error_group_is_locked("error_group_is_locked", "Le groupe est verrouillé"),
    group_is_now_locked("group_is_now_locked", "Le groupe est maintenant verrouillé"),
    group_is_now_unlocked("group_is_now_unlocked", "Le groupe est maintenant déverrouillé"),
    ...
    hud_game_state("hud_game_state", "État: %playerGroupState%"),
    ...
    referee_item_inventory_map_selector_title("referee_item_inventory_map_selector_title", "Sélectionner une carte à jouer"),
    ...
    stats_most_talking_title("stats_most_talking_title", "Le blablateur"),
    ...
    hud_team_text("hud_team_text", "Équipe:"),
    ...
    kit_warrior_description("kit_warrior_description", "Vous faites 25% de dégâts en plus, mais perds se déplace 15% moins vite"),
    ...
    kit_toughguy_description("kit_toughguy_description", "Vous avez 15 coeurs, 15% de dégâts en moins, et 15% de vitesse en moins"),
    ...
    hud_current_game_state("hud_current_game_state", "État: "),
